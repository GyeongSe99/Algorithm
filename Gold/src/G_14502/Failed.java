...
public class Failed {
    ...
    static int[][] lab, copy;
    static boolean[][] wallVisited, dfsVisited;
    ...
    static void buildWall(int r, int c, int idx) {
        // 인덱스 저장
        wallPosition[idx][0] = r;
        wallPosition[idx][1] = c;
        ...
        if (idx == 2) { // 벽을 3개 세웠을때
            ...
            // 진짜로 벽 표시
            for (int i = 0; i < 3; i++) {
                copy[wallPosition[i][0]][wallPosition[i][1]] = 1;
            }
